...
function flash(msg) {
  ...
  // Scale duration with message length: 80ms/char on top of a 3s floor,
  // capped at 12s. Click anywhere on the toast to dismiss early.
  const ms = Math.min(12000, 3000 + msg.length * 80);
